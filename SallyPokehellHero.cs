...
public class Sally : ModHero
{
    ...
    public override string Level1Description => "Quickly throws pins at the Bloons. All [TackShooters] in radius get more range.";
...
{
    public override string Description => "[SallyPokehellHero-Sally] can detect Camo Bloons. Also allows all [TackShooters] and [SallyPokehellHero-Sally Short Description] in radius to attack [ft_camobloonstitle].";
...
{
    public override string Description => "[SallyPokehellHero-Sally]'s pins can pop Frozen Bloons.";
...
{
    public override string Description => "[Bloon Bleed] Plus: Every 4th attack causes a slow damage over time effect and pop twice as many layers of Bloon. Ability cooldowns reduced by 15%. Pins do +5 more damage to [ft_moabclassbloonstitle].";
